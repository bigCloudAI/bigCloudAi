...
define('mq.portal',[
    ...
    J.$package("mq",function(J){
        ...
        // monitor视图ID：16049
        this.monitor = function(n){Object.prototype.toString.call(n)!=="[object Array]"&&(n=[n]);var t="//report.url.cn/report/report_vm?monitors=["+n.join(",")+"]&t="+ new Date,i=new Image;i.src=t};
...
//联系人model类
    J.$package("mq.model.buddylist",function(J){
        ...
        //数据列表
        var categoriesList = [],groupList = [],recentList = [],friendsList = [],discussList = [] ,sigList = [] ,id2category = {},uin2Friend = {} ,gid2group = {} ,id2discuss = {} ,uin2sig = {},strangerList = [],uin2stranger={};
