...
public class Webqq {
    ...
    public Webqq initWebqq(){
		...
		try {
			...
			/*	this.get_self_info2();
				...
				Thread.sleep(3000l);
				System.out.println("good:"+this.webqqSocket.content);
				//Thread.sleep(1000l);
    ...
    public static void main2(String[] args) {
		...
		webqq.vfwebqq="d2ab661ad82e76198f2aeb0375b8d0a5adc2d1b557e35f661f023a0ed4a33911223c2d1a35755e6f";
		webqq.psessionid="8368046764001d636f6e6e7365727665725f77656271714031302e3133332e34312e383400001ad00000066b026e040015808a206d0000000a406172314338344a69526d0000002859185d94e66218548d1ecb1a12513c86126b3afb97a3c2955b1070324790733ddb059ab166de6857";
		webqq.webqqSocket.cookieMaps.put("p_uin", "o0766597324");
		webqq.webqqSocket.cookieMaps.put("p_skey", "umfEuiUPQ16WLhQeuLle4JlLzz1fTAnFwje0ymDwfA4_");
		webqq.webqqSocket.cookieMaps.put("pt4_token", "3XHPMgf1pUuh4iGztRmQU9HTZQJE1PsDOOWsWaKHuXs_");
		webqq.webqqSocket.cookieMaps.put("skey", "@c8EZZawel");
		webqq.webqqSocket.cookieMaps.put("uin", "766597324");
		
		//webqq.get_self_info2();
		webqq.get_user_friends2();
		try {
			String to="3526455190";
		//	webqq.send_buddy_msg2("ÖÐ¹úhahahahha¹þ¹þ¹þ",to);
			//System.out.println(URLEncoder.encode("\"ÖÐ¹ú\"","UTF-8"));
		} catch (Exception e) {
	...
	public void get_user_friends2(){
		try {
			...
			dos.writeBytes("\r\n");
			System.err.println("Cookie: uin=o0766597324; skey="+webqqSocket.cookieMaps.get("skey")+";"
					+ " p_uin="+webqqSocket.cookieMaps.get("p_uin")+";"
					+ " p_skey="+webqqSocket.cookieMaps.get("p_skey")+";"
					+ " pt4_token="+webqqSocket.cookieMaps.get("pt4_token")+"\r\n");
			System.err.println(contenttemp);
	...
	public void send_buddy_msg2(String msg,String to) throws Exception{
	   ...
	   String contenttemp = "r="
			...
			+ "psessionid%22%3A%22"+this.psessionid+"%22%7D";
		try {
			Socket qqSocket = new Socket("d1.web2.qq.com",80);
			if(webqqSocket!=null){
				webqqSocket.setWebqqSocket(qqSocket);
	...
	public String hash2(){
        ...
        /* engine.put("a", 4);   
         ...
         try {
        	 engine.eval(js);
     		this.webqqSocket.cookieMaps.put("uin", "766597324");
