 ...
 engine.timing.timeScale = 0.9;
    ...
    World.add(world, [
       ...
       /* Bodies.rectangle(400, 600, 800, 50, { isStatic: true }),
        ...
        Bodies.rectangle(400, 595, 800, 50, { isStatic: true })
    ]);

  World.add(world, Bodies.circle(400, 10, 20));
    /*var scale = 0.9;
    ...
    World.add(world, [
        Bodies.rectangle(308, 250, 200, 20, { isStatic: true, angle: -Math.PI * 0.1 }),
        Bodies.rectangle(493, 250, 200, 20, { isStatic: true, angle: Math.PI * 0.1 }),
